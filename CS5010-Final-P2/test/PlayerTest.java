...
/**
 * The class containing the JUnit tests for the model.Player class.
 */
public class PlayerTest {
    private Player player;
    private final LocalDate birthDate = LocalDate.of(2019, 1, 1);
    ...
    /**
     * Test the constructor of the model.Player class.
     */
    @Test
    ...
    /**
     * Test the constructor of the model.Player class with invalid skill level.
     */
    ...
    /**
     * Test the toString method of the model.Player class.
     */
    @Test
    public void testToString() {
        ...
        String expected = "First name: John  Last name: Doe  Jersey Number: 10  Skill Level: " +
                "3  Preferred model.Position: Forward  Current model.Position: Midfielders";
        assertEquals(expected, player.toString());
    }

    /**
     * Test the constructor of the model.Player class with future birth date.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Test the constructor of the model.Player class with null firstName.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Test the constructor of the model.Player class with null lastName.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Test the constructor of the model.Player class with null birthDate.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Test the constructor of the model.Player class with null preferredPosition.
     */
    @Test(expected = IllegalArgumentException.class)
