...
/**
 * The class containing the JUnit tests for the model.Team class.
 */
public class TeamTest {
    ...
    public void setUp() {
        ...
        for (int i = 0; i < 12; i++) {
            if (i >= 10){
                players.add(new Player("First" + i, "Last" + i, LocalDate.of(2024 - i+2, 1, 1),
    ...
    public void testAddPlayer() {
        Player newPlayer = new Player("New", "model.Player", LocalDate.of(2019, 5, 1),
                Position.Forward, Position.NotAssigned, 3);
    ...
    public void testAddPlayerException() {
        Player invalidPlayer = new Player("Invalid", "model.Player", LocalDate.of(2017, 5, 1),
                Position.NotAssigned, Position.NotAssigned, 6);
