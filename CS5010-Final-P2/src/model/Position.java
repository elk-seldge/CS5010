...
/**
 * The model.Position enum represents the different positions a player can have in a team.
...
public enum Position {
   ...
   * This class is a part of the larger model.Position enum, which includes other player positions as well.
   */
  Goalie,
  /**
   ...
   * It is a part of the model.Position enum and represents a specific category of players within a team.
   */
  Midfielders,
  /**
   * The Forward variable represents the position of a player in a team.
   * It is one of the possible positions defined by the model.Position enum.
   ...
   * It is used in the model.Position enum to indicate that a player's position has not been assigned yet.
   * @see Position
   */
  NotAssigned
}
