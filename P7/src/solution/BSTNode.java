...
public interface BSTNode<T extends Comparable<T>> {
   ...
   * @param data T type object to be inserted to BST
   * @return The head node of the BST
   */
  BSTNode<T> insert(T data);

  /**
   * Determine and return the minimum element in the tree rooted at this node
   * @return The T type object of the node contains the smallest element
   ...
   * @return String object stands for the tree
   */
  String toString();
