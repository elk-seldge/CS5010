 ...
 * It includes the positions of Goalies, Defenders, Midfielders, Forwards, and NotAssigned.
 */
public enum Positions {
   ...
   * It is used to group the players who play in the defender position.
   */
  Defenders,
  /**
   ...
   * The other possible positions are Goalies, Defenders, Midfielders, and NotAssigned.
   */
  Forward,
  /**
